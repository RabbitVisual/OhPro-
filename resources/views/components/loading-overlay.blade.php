@php
    $loadingIcons = config('icon.homepage.loading', ['book-open-reader', 'chalkboard-user', 'graduation-cap', 'school', 'laptop-code', 'pencil-paintbrush']);
    $firstIcon = $loadingIcons[0] ?? 'book-open-reader';
    $iconsJson = json_encode($loadingIcons);
@endphp
<div x-data='{
    loading: false,
    timeout: null,
