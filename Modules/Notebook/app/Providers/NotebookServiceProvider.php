...
namespace Modules\Notebook\Providers;
...
class NotebookServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Notebook';

    protected string $nameLower = 'notebook';
    ...
    public function boot(): void
    {
        ...
        \Livewire\Livewire::component('notebook.attendance-scanner', \Modules\Notebook\Livewire\AttendanceScanner::class);
