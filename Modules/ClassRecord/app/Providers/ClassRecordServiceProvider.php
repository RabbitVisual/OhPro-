...
namespace Modules\ClassRecord\Providers;
...
class ClassRecordServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'ClassRecord';

    protected string $nameLower = 'classrecord';
