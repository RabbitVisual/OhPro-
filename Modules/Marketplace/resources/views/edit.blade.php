<x-marketplace::layouts.master>
    <div class="p-6 max-w-2xl mx-auto">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">Módulo Marketplace. Implemente o método update() no controller quando necessário.</p>
        <form action="{{ route('marketplace.update', $id ?? 1) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
