<x-workspace::layouts.master>
    <div class="w-full">
        <header class="mb-8">
            <h1 class="text-2xl md:text-3xl font-display font-bold text-slate-900 dark:text-white tracking-tight">Novo workspace</h1>
            <p class="mt-1 text-slate-500 dark:text-slate-400">Crie um novo recurso. Implemente o método store() no controller e defina as rotas quando necessário.</p>
        </header>
        <form action="#" method="POST" class="max-w-xl space-y-4">
            ...
            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Salvar</button>
